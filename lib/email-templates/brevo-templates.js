    ...
    <div style="max-width: 600px; margin: 0 auto;">
      ...
      <div style="background: #e8f5e9; padding: 20px; margin: 20px 0; text-align: center; border-radius: 8px;">
        <a href="{{ params.walletPassUrl }}" style="display: inline-block; text-decoration: none; margin: 10px;">
          <img src="https://developer.apple.com/wallet/add-to-apple-wallet-guidelines/images/Download_on_the_App_Store_Badge_US-UK_RGB_blk_092917.svg" alt="Add to Apple Wallet" style="height: 48px;">
        </a>
        <a href="{{ params.googleWalletUrl }}" style="display: inline-block; text-decoration: none; margin: 10px;">
          <img src="https://developers.google.com/pay/passes/guides/get-started/implementing-the-api/save-to-google-pay-button" alt="Add to Google Wallet" style="height: 48px;">
        </a>
      </div>
