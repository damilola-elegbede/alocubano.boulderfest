                                    ...
                                    <tr>
                                      <td style="font-size: 0px; line-height: 0px; padding-bottom: 5px; padding-top: 5px;">
                                        <a href="https://www.alocubanoboulderfest.org/" target="_blank" style="color: #666; text-decoration: underline;">
                                          <img src="https://creative-assets.mailinblue.com/editor/social-icons/squared_light/website_32px.png" width="32" height="32" border="0" style="display: block;">
                                        </a>
                                      </td>
                                    ...
                                    <tr>
                                      <td style="font-size: 0px; line-height: 0px; padding-bottom: 5px; padding-top: 5px;">
                                        <a href="https://www.instagram.com/alocubano.boulderfest/" target="_blank" style="color: #666; text-decoration: underline;">
                                          <img src="https://creative-assets.mailinblue.com/editor/social-icons/squared_light/instagram_32px.png" width="32" height="32" border="0" style="display: block;">
                                        </a>
                                      </td>
                                      <td width="5" style="font-size: 0px; line-height: 1px;">­</td>
                                    </tr>
                                    ...
                                    <tr>
                                      <td style="font-size: 0px; line-height: 0px; padding-bottom: 5px; padding-top: 5px;">
                                        <a href="https://chat.whatsapp.com/KadIVdb24RWKdIKGtipnLH" target="_blank" style="color: #666; text-decoration: underline;">
                                          <img src="https://creative-assets.mailinblue.com/editor/social-icons/squared_light/whatsapp_32px.png" width="32" height="32" border="0" style="display: block;">
                                        </a>
                                      </td>
                                    </tr>
                                  </table>
