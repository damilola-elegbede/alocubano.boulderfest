                        ...
                        <tr>
                          <td align="center" style="padding-top: 10px; padding-bottom: 5px;">
                            <p style="margin: 0; font-size: 11px; color: #999; line-height: 1.4;">
                              You have the right to request deletion of your personal data.<br>
                              Contact us at the email above with "Data Deletion Request" in the subject.
                            </p>
                          </td>
                        </tr>
                      </table>
                                                                            ...
                                                                            <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="106" class="r3-o" style="table-layout: fixed; width: 106px;">
                                                                                <tr>
                                                                                    <td style="font-size: 0px; line-height: 0px;">
                                                                                        <img src="https://img.mailinblue.com/9670291/images/content_library/original/68a6c02f3da913a8d57a0190.png" width="106" border="0" style="display: block; margin: 0 auto;">
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
