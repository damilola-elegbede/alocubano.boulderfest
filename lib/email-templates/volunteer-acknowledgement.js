...
export function generateVolunteerAcknowledgementEmail(data) {
  ...
  const content = `
    <div style="max-width: 600px; margin: 0 auto;">
      ...
      <p style="margin: 0 0 15px 0;">Hi ${escapeHtml(firstName)}!</p>
        ...
        <div style="margin-bottom: 15px;">
          ...
          <ul style="margin: 0; padding-left: 20px; list-style-type: disc;">
            ${areasOfInterest.map(area => {
              ...
              return `<li style="margin: 4px 0; font-size: 14px;">${escapeHtml(areaLabels[area] || area)}</li>`;
            }).join('')}
          </ul>
        </div>
        ` : ''}
        ...
        <div>
          ...
          <ul style="margin: 0; padding-left: 20px; list-style-type: disc;">
            ${availability.map(day => {
              ...
              return `<li style="margin: 4px 0; font-size: 14px;">${escapeHtml(dayLabels[day] || day)}</li>`;
            }).join('')}
          </ul>
        </div>
        ` : ''}
