...
class TicketColorService {
   ...
   * NOTE: These mappings must be kept in sync with migrations/034_ticket_type_colors.sql
   * Update this fallback whenever the seed data changes.
   */
  loadFallbackMappings() {
    ...
    this.cache.set('class', { name: 'Single Class', rgb: 'rgb(34, 139, 34)', emoji: '⬤', display_order: 10 });
