...
class TicketColorService {
   ...
   *
   * IMPORTANT: These fallback mappings must be kept in sync with the database
   * schema in migrations/005_add_ticket_type_colors.sql. When adding new ticket
   * types or changing colors in the database, update this fallback list to match.
   *
   * The fallback ensures the application remains functional during database outages
