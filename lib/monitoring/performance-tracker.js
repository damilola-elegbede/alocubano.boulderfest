...
export class PerformanceTracker {
  ...
  /**
   * Record metric (for compatibility with monitoring service)
   */
  recordMetric(endpoint, duration, metadata = {}) {
    // Default to 200 status code for successful operations
    const statusCode = metadata.statusCode || 200;
    return this.trackEndpointPerformance(endpoint, duration, statusCode, metadata);
  }
