...
import { setSecureCorsHeaders } from "./cors-config.js";
...
/**
 * API-specific security headers with secure CORS configuration
 */
export function addAPISecurityHeaders(req, res, options = {}) {
  ...
  // Use secure CORS configuration instead of manual headers
  if (enableSecureCors) {
