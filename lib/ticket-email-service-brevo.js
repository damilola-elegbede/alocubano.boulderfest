...
`;
  ...
  formatTicketDetailsForEmail(ticketDetails) {
    ...
    return ticketDetails
      .map((ticket, index) => `
<table style="width: 100%; border-collapse: collapse; background: #f5f5f5; border-left: 4px solid #cc2936; margin-bottom: 15px;">
  <tr>
    <td style="width: 40px; padding: 15px 10px; vertical-align: top; text-align: center;">
      <span style="background: #cc2936; color: white; border-radius: 50%; width: 28px; height: 28px; display: inline-block; text-align: center; line-height: 28px; font-weight: bold;">${index + 1}</span>
    </td>
