...
export class RateLimitService {
  constructor() {
    ...
    this.isTestEnvironment = process.env.E2E_TEST_MODE === 'true' || 
                            process.env.CI === 'true' ||
    ...
    this.loginMaxAttempts = this.isTestEnvironment ? 999 : 5; // Effectively unlimited in test environments
    this.lockoutDuration = this.isTestEnvironment ? 1000 : 900000; // 1 second vs 15 minutes lockout
  }
