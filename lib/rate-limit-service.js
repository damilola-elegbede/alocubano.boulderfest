...
export class RateLimitService {
  ...
  async checkRateLimit(req, customLimit = null) {
    // Run cleanup before operations to prevent memory leaks
    this.cleanup();
...
export function getRateLimitService() {
  if (!rateLimitInstance) {
    ...
    // Note: setInterval disabled for Vercel serverless compatibility
    // Cleanup will be called on demand during operations
  }
