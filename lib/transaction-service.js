...
export class TransactionService {
  ...
  async getByStripeSessionId(sessionId) {
    ...
    return {
      id: sanitizedRow[0],
      transaction_id: sanitizedRow[1],
      uuid: sanitizedRow[2],
      type: sanitizedRow[3],
      order_data: sanitizedRow[4],
      amount_cents: sanitizedRow[5],
      total_amount: sanitizedRow[5],  // Add alias for email service compatibility
      currency: sanitizedRow[6],
      stripe_session_id: sanitizedRow[7],
      stripe_payment_intent_id: sanitizedRow[8],
      paypal_order_id: sanitizedRow[9],
      paypal_capture_id: sanitizedRow[10],
      payment_method_type: sanitizedRow[11],
      customer_email: sanitizedRow[12],
      customer_name: sanitizedRow[13],
      billing_address: sanitizedRow[14],
      status: sanitizedRow[15],
      completed_at: sanitizedRow[16],
      created_at: sanitizedRow[17],
      updated_at: sanitizedRow[18],
      registration_token: sanitizedRow[19],
      is_test: sanitizedRow[20],
      order_number: sanitizedRow[21]
    };
  }
