...
export class GoogleWalletService {
  ...
  formatDateTimeForWallet(dateString, isEndDate = false) {
    ...
    // LIMITATION: Using fixed MST (-07:00) for simplicity; does not account for DST
    // This may create a 1-hour discrepancy for events during DST periods (Mar-Nov)
    // Google Wallet accepts any valid timezone offset
    // TODO: Consider using date-fns-tz or Luxon for DST-aware timezone handling
