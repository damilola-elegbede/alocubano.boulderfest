...
export class AppleWalletService {
  ...
  async createPassFile(ticket, serialNumber) {
    ...
    const passProps = {
      ...
      logoText: isTest ? "A Lo Cubano (TEST)" : "A Lo Cubano",
    ...
    // CRITICAL: Set the pass type BEFORE setting fields
    // WARNING: Setting type AFTER fields will reset them!
    // The eventTicket: {} in passProps only sets the structure, not the type
    pass.type = "eventTicket";

    // Pass structure for event ticket fields
    // MUST be set AFTER pass.type to avoid field reset
    pass.eventTicket = {
      // Primary fields
      primaryFields: [
        {
