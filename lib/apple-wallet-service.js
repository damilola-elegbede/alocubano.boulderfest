...
export class AppleWalletService {
  ...
  async createPassFile(ticket, serialNumber) {
    ...
    const passProps = {
      ...
      logoText: "A Lo Cubano\nBoulder Fest",   // Text beside logo (Apple controls positioning)
    ...
    try {
      ...
      // Logo - 120x40 points (displayed with logoText)
      ...
      const logo3xPath = path.join(projectRoot, "public", "wallet", "logo@3x.png");
