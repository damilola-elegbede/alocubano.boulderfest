...
export class AppleWalletService {
  ...
  async createPassFile(ticket, serialNumber) {
    ...
    const passProps = {
      ...
      // Visual Styling (Black background with white text and Cuban blue labels)
      ...
      labelColor: "rgb(0, 42, 143)",           // Cuban blue labels (#002A8F)
