...
export class AppleWalletService {
  ...
  async createPassFile(ticket, serialNumber) {
    ...
    const passProps = {
      ...
      foregroundColor: "rgb(0, 0, 0)",         // Black text for field values (fallback for older iOS)
      backgroundColor: "rgb(255, 255, 255)",   // White background (ignored when background image present)
      labelColor: "rgb(206, 17, 38)",          // Cuban red labels

      // iOS 18+ Enhanced Event Ticket features
      // Use preferredStyleSchemes to enable new poster layout + useAutomaticColor
      preferredStyleSchemes: ["eventTicket"],  // iOS 18+ new layout (maintains classic style)
      useAutomaticColor: true,                  // Auto-detect text color from white background (sets text to BLACK)
