...
class PayPalService {
  ...
  async createOrder(orderData, req = null) {
    ...
    try {
      ...
      const response = await this.ordersController.ordersCreate(createOrderRequest);
  ...
  async captureOrder(orderId, captureData = {}, req = null) {
    ...
    try {
      ...
      const response = await this.ordersController.ordersCaptureOrder(captureOrderRequest);
  ...
  async getOrder(orderId, req = null) {
    ...
    try {
      ...
      const response = await this.ordersController.ordersGet(getOrderRequest);
