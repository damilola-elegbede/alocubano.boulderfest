...
export function addSecurityHeaders(res, options = {}) {
  ...
  const cspDirectives = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' https://js.stripe.com https://cdn.jsdelivr.net https://www.googletagmanager.com https://www.google-analytics.com https://vercel.live",
    ...
    "connect-src 'self' https://api.stripe.com https://m.stripe.com https://m.stripe.network https://api.brevo.com https://www.google-analytics.com https://vercel.live https://*.pusher.com wss://*.pusher.com https://cdn.jsdelivr.net",
