...
export class RegistrationTokenService {
  constructor() {
    this.secret = null;
    // FIXED: Changed from 72 hours to 1 year to prevent tickets becoming inaccessible
    // Registration deadline is checked via database, not JWT expiration
    // This ensures users can always view tickets until after the event
    this.tokenExpiry = 365 * 24 * 60 * 60; // 1 year in seconds (event-based, not arbitrary)
