...
export class AuthService {
  constructor() {
    ...
    // Environment detection - E2E tests include preview deployments
    this.isE2ETest = process.env.E2E_TEST_MODE === 'true' || 
                     process.env.CI === 'true' ||
                     process.env.VERCEL_ENV === 'preview';  // Vercel preview deployments are treated as E2E test environments
