...
export class AuthService {
  ...
  async ensureInitialized() {
    ...
    try {
      ...
      // Check for initialization errors after attempt
      if (this.initializationError) {
        throw this.initializationError;
      }
  ...
  async _performInitialization() {
    try {
      ...
      if (!process.env.ADMIN_SECRET) {
        ...
        // Use a runtime error instead of throwing during initialization
        this.initializationError = new Error("❌ FATAL: ADMIN_SECRET not configured");
        return;
      }
      ...
      if (this.sessionSecret.length < 32) {
        ...
        // Use a runtime error instead of throwing during initialization
        this.initializationError = new Error("ADMIN_SECRET must be at least 32 characters long");
        return;
      }
