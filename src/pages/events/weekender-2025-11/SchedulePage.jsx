/**
 * Weekender November 2025 Schedule Page
 *
 * Displays the single-day schedule for the weekender event.
 */
...
function SchedulePageContent() {
    const { schedule, featuredArtist } = useEvent();
        ...
        <EventLayout>
            ...
            <section className="section-typographic">
                <div className="container">
                    <h1 className="text-mask">Workshop Schedule</h1>
                    <p
                    ...
                    >
                        A full day of Cuban dance with {featuredArtist?.name || 'our featured artist'}
                    </p>
                </div>
            </section>
...
export default function Weekender202511SchedulePage() {
    return (
        <AppProviders>
