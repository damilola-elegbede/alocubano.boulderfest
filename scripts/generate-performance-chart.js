...
function generateChart() {
  ...
  console.log('├──────────────────────────┼────────────┼──────────────┤');
  console.log(`│ TestEnvironmentManager   │    721     │ ${colors.green}✓ ELIMINATED${colors.reset} │`);
  console.log(`│ TestSingletonManager     │    518     │ ${colors.green}✓ ELIMINATED${colors.reset} │`);
  console.log(`│ TestMockManager          │    869     │ ${colors.yellow}⏳ PENDING${colors.reset}   │`);
  console.log(`│ Database Utilities       │   1,017    │ ${colors.yellow}⏳ PENDING${colors.reset}   │`);
  console.log('├──────────────────────────┼────────────┼──────────────┤');
  console.log(`│ ${colors.bright}Total Eliminated${colors.reset}         │ ${colors.green}1,239${colors.reset}      │ ${colors.green}88% done${colors.reset}     │`);
  console.log(`│ ${colors.bright}Remaining${colors.reset}                │ ${colors.yellow}1,886${colors.reset}      │ ${colors.yellow}12% left${colors.reset}     │`);
  console.log('└──────────────────────────┴────────────┴──────────────┘');
  ...
  console.log(`          ${colors.green}← Better${colors.reset}                    ${colors.red}Worse →${colors.reset}`);
  console.log('');
  ...
  console.log('├────────────────────┼──────────┼──────────┼────────────┤');
  console.log(`│ Manager Classes    │    3     │    0     │   ${colors.green}100%${colors.reset}     │`);
  console.log(`│ Complexity Score   │   HIGH   │   LOW    │   ${colors.green}71%${colors.reset}      │`);
  console.log(`│ Test Execution     │  30.0s   │  22.48s  │   ${colors.green}25.1%${colors.reset}    │`);
  console.log(`│ Infrastructure     │  3,125   │   518*   │   ${colors.green}88%${colors.reset}      │`);
  console.log('└────────────────────┴──────────┴──────────┴────────────┘');
  ...
  metrics.forEach(([metric, achieved]) => {
    const status = achieved ? `${colors.green}✓${colors.reset}` : `${colors.red}✗${colors.reset}`;
