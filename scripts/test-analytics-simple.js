...
async function runTests() {
  console.log(`${colors.blue}🚀 Testing Analytics Service Directly${colors.reset}`);
  ...
  try {
    ...
    console.log(`${colors.cyan}👥 Testing Customer Analytics...${colors.reset}`);
    const customers = await analyticsService.getCustomerAnalytics();
    console.log(`${colors.green}✅ Customer Analytics:${colors.reset}`);
    console.log(`  - Unique Customers: ${customers.summary?.unique_customers || 0}`);
    ...
    console.log(`  - Adoption Rate: ${wallet.summary?.overall_adoption_rate || 0}%`);
    console.log('');
    ...
    console.log(`  - Days Until Event: ${summary.overview?.days_until_event || 0}`);
    console.log(`  - Recommendations: ${summary.recommendations?.length || 0}`);
    
    console.log(`\n${colors.green}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}`);
    console.log(`${colors.green}✅ All Analytics Service Tests Passed!${colors.reset}`);
