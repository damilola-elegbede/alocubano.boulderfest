...
const OUTPUT_FILE = path.join(__dirname, '..', 'public', 'featured-photos.json');
...
async function fetchFeaturedPhotos() {
  console.log(`Fetching featured photos from Google Drive folder: ${FEATURED_PHOTOS_FOLDER_ID}...`);
  
  if (!FEATURED_PHOTOS_FOLDER_ID) {
    throw new Error('Featured photos folder ID is required. Please set GOOGLE_DRIVE_FEATURED_PHOTOS_FOLDER_ID or GOOGLE_DRIVE_FOLDER_ID.');
  }
