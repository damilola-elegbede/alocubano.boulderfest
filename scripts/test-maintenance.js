...
const TestMaintenance = {
  ...
  generateHealthReport: () => {
    ...
    fs.writeFileSync('test-health-report.json', JSON.stringify(report, null, 2));
...
switch (command) {
  ...
  case 'health':
    ...
    break;
  default:
    console.log('Usage: node scripts/test-maintenance.js [flaky|cleanup|performance|health]');
}