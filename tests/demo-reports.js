...
class ReportingDemo {
    ...
    generateMockDetails() {
        ...
        brokenUrls.forEach((url, index) => {
            details.push({
                url,
                type: url.includes('http') ? 'external' : 
                      url.includes('.css') || url.includes('.jpg') ? 'asset' : 'navigation',
    ...
    generateMockBrokenLinks() {
        return [
            ...
            },
            {
                ...
                context: '<a href="https://example-broken-external.com">External Link</a>'
            }
        ];
    }
    ...
    generateMockSuggestions() {
        return [
            ...
            },
            {
                ...
                message: 'Review external links and consider implementing link monitoring'
            },
            {
                priority: 'low',
                category: 'Performance',
                message: 'Consider implementing automated link checking in CI/CD pipeline'
            }
        ];
    }
