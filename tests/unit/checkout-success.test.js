...
describe('Checkout Success Handler', () => {
    ...
    describe('Request Validation', () => {
        ...
        it('should accept valid session_id format', async () => {
            ...
            expect(res._getStatusCode()).toBe(200);
            expect(mockStripe.checkout.sessions.retrieve).toHaveBeenCalledWith('cs_test_valid_session');
        });
    });
    ...
    describe('Session Validation', () => {
        ...
        it('should reject unpaid sessions', async () => {
            ...
            expect(responseData.message).toBe('Payment was not successfully completed');
    ...
    describe('Order Status Updates', () => {
        ...
        const createValidOrder = (orderId = 'order_123') => ({
            ...
            order_details: JSON.stringify({
                items: [
                    { name: 'Early Bird Ticket', price: 25, quantity: 2 }
                ]
            }),
            created_at: '2025-01-01 12:00:00'
        });
        ...
        it('should successfully update order status to paid', async () => {
            ...
            expect(responseData.message).toBe('Payment successful! Thank you for your purchase.');
    ...
    describe('Stripe Error Handling', () => {
        ...
        it('should handle unknown errors', async () => {
            ...
            expect(responseData.message).toBe('An unexpected error occurred while verifying your payment');
        });
    });
