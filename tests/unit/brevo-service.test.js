...
describe('BrevoService', () => {
    ...
    describe('constructor', () => {
        ...
        it('should throw error if API key is missing', () => {
            delete process.env.BREVO_API_KEY;
            expect(() => new BrevoService()).toThrow('BREVO_API_KEY environment variable is required');
        });
    ...
    describe('makeRequest', () => {
        it('should make successful API request', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('https://api.brevo.com/v3/test', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'api-key': 'test-api-key'
        ...
        it('should handle API errors', async () => {
            ...
            await expect(brevoService.makeRequest('/test')).rejects.toThrow('Brevo API error: 400 - Bad request');
        });
        
        it('should handle network errors', async () => {
            global.fetch.mockRejectedValueOnce(new Error('Network error'));
            
            await expect(brevoService.makeRequest('/test')).rejects.toThrow('Network error');
        });
    });
    ...
    describe('subscribeToNewsletter', () => {
        ...
        it('should handle duplicate contact gracefully', async () => {
            const duplicateError = new Error('Brevo API error: 400 - duplicate_parameter');
    ...
    describe('unsubscribeContact', () => {
        ...
        it('should handle contact not found gracefully', async () => {
            const notFoundError = new Error('Brevo API error: 404 - contact_not_exist');
    ...
    describe('validateWebhookSignature', () => {
        ...
        it('should reject incorrect signature', () => {
            ...
            const isValid = brevoService.validateWebhookSignature(payload, wrongSignature);
