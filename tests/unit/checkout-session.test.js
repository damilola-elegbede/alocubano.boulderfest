...
describe('Checkout Session Creation', () => {
    beforeEach(async () => {
        ...
        const module = await import('../../api/payments/create-checkout-session.js');
    ...
    describe('Request Validation', () => {
        ...
        it('should reject incomplete customer information', async () => {
            const { req, res } = createMocks({
                ...
                body: {
                    cartItems: [
                        { name: 'Early Bird Ticket', price: 25, quantity: 1, type: 'ticket' }
                    ],
                    customerInfo: {
                        email: 'test@example.com'
        ...
        it('should validate cart item structure', async () => {
            const { req, res } = createMocks({
                ...
                body: {
                    cartItems: [
                        { name: 'Early Bird Ticket', price: 25, quantity: 0, type: 'ticket' } // Invalid quantity
                    ],
                    customerInfo: {
                        email: 'test@example.com',
                        firstName: 'John',
    ...
    describe('Stripe Integration', () => {
        ...
        it('should handle Stripe API errors', async () => {
            ...
            expect(responseData.message).toBe('Payment service temporarily unavailable');
        });
