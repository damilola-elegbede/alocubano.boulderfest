...
describe('Multi-Year Gallery Manager - Current Single Year (2025) with Future Multi-Year Support', () => {
    ...
    beforeAll(() => {
        ...
        const originalDispatchEvent = MultiYearGalleryManager.prototype.dispatchEvent;
        MultiYearGalleryManager.prototype.dispatchEvent = function(eventName, detail = {}) {
            try {
    ...
    describe('Initialization', () => {
        ...
        test('should create proper DOM structure', async () => {
            ...
            const multiYearContainer = mockContainer.querySelector('.multi-year-gallery');
            ...
            const galleryContainer = mockContainer.querySelector('.gallery-container');
    ...
    describe('Current State - Single Year (2025) Support', () => {
        test('should handle current single year (2025) from API', async () => {
            ...
            expect(gallery.yearStatistics.get('2025')).toEqual({ imageCount: 10, totalSize: 1000000 });
        });
    ...
    describe('Error Handling', () => {
        ...
        test('should handle empty gallery data', async () => {
            ...
            expect(emptyMessage.textContent).toContain('No images available for 2025');
