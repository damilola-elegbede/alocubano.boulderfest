  ...
  describe('Payment Intent Creation', () => {
    it('should create payment intent with correct data', async () => {
      const orderData = {
        ...
        orderDetails: {
          tickets: [
            { type: 'full-pass', quantity: 1, price: 125, name: 'Full Festival Pass' }
          ]
        },
        customerInfo: {
          firstName: 'John',
      ...
      expect(fetch).toHaveBeenCalledWith('/api/payments/create-payment-intent', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(orderData)
      });
  ...
  describe('UI Integration', () => {
    it('should show payment modal with order summary', () => {
      const orderData = {
        ...
        orderDetails: {
          tickets: [
            { name: 'Full Festival Pass', quantity: 1, price: 125 }
          ]
        }
      };
