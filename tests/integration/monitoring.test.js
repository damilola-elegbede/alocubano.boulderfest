...
describe.skipIf(!serverAvailable)("Production Monitoring System", () => {
  describe("Health Check Endpoint", () => {
    ...
    it("should check specific service health", async () => {
      const response = await fetch(
        `${BASE_URL}/api/health/check?service=database`,
      );
      const data = await response.json();
    ...
    it("should return 404 for unknown service", async () => {
      const response = await fetch(
        `${BASE_URL}/api/health/check?service=unknown`,
      );
      const data = await response.json();
  ...
  describe("Metrics Export", () => {
    ...
    it("should return metrics in JSON format", async () => {
      const response = await fetch(
        `${BASE_URL}/api/monitoring/metrics?api_key=${METRICS_API_KEY}`,
      );
  ...
  describe("Alert Management", () => {
    ...
    it("should get active alerts", async () => {
      const response = await fetch(
        `${BASE_URL}/api/monitoring/alerts?action=active`,
      );
      const data = await response.json();
    ...
    it("should get alert templates", async () => {
      const response = await fetch(
        `${BASE_URL}/api/monitoring/alerts?action=templates`,
      );
      const data = await response.json();
    ...
    it("should require admin access for configuration", async () => {
      const response = await fetch(
        `${BASE_URL}/api/monitoring/alerts?action=configuration`,
      );
  ...
  describe.skip("Dashboard", () => {
    ...
    it.skip("should return HTML dashboard when requested", async () => {
      const response = await fetch(
        `${BASE_URL}/api/monitoring/dashboard?format=html`,
      );
      ...
      expect(html).toContain(
        "A Lo Cubano Boulder Fest - Production Monitoring",
      );
    });

    it("should generate platform-specific configuration", async () => {
      const response = await fetch(
        `${BASE_URL}/api/monitoring/dashboard?platform=grafana`,
      );
      const data = await response.json();
    ...
    it("should return error for invalid platform", async () => {
      const response = await fetch(
        `${BASE_URL}/api/monitoring/dashboard?platform=invalid`,
      );
      const data = await response.json();
  ...
  describe.skip("Integration Tests", () => {
    it("should handle high load gracefully", async () => {
      const requests = Array(10)
        .fill(null)
        .map(() => fetch(`${BASE_URL}/api/health/check`));
