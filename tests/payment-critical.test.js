...
test('payment rejects amount manipulation', async () => {
  const attacks = [
    { cartItems: [{ name: 'Ticket', price: -100, quantity: 1 }], customerInfo: { email: 'test@example.com' } },
    { cartItems: [{ name: 'Ticket', price: 0, quantity: 1 }], customerInfo: { email: 'test@example.com' } }];
