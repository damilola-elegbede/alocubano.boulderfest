...
CREATE INDEX IF NOT EXISTS idx_tickets_scan_validation ON tickets(ticket_id, scan_count, max_scan_count, status);
...
CREATE INDEX IF NOT EXISTS idx_tickets_validation_composite ON tickets(ticket_id, status, scan_count, max_scan_count);