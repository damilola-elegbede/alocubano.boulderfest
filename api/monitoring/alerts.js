  ...
  try {
    ...
    return {
      ...
      message: result.sent
        ...
        : 'Test alert was suppressed or failed'
    };
  } catch (error) {
    return {
      success: false,
...
function validateAlertRule(rule) {
  ...
  if (
    ...
    !validOperators.includes(rule.conditions.operator)
  ) {
    errors.push(
  ...
  if (
    ...
    !validSeverities.includes(rule.actions.severity)
  ) {
    errors.push(
  ...
  if (
    ...
    !validCategories.includes(rule.actions.category)
  ) {
    errors.push(
