...
export default async function handler(req, res) {
    ...
    try {
        ...
        console.log(`Checkout cancelled - Session: ${session_id}, Order: ${order_id}`);
            ...
            try {
                ...
                if (existingOrder) {
                    ...
                    if (existingOrder.fulfillment_status === 'awaiting_payment') {
                        ...
                        console.log(`Order ${order_id} status is ${existingOrder.fulfillment_status}, not updating`);
                    }
                } else {
        ...
        res.status(200).json({
            ...
            error: 'There was an issue processing your cancellation, but your checkout was cancelled successfully.'
        });
    }
}